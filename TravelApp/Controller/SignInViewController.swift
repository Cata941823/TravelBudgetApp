...
class SignInViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        con.createTable(query: "CREATE TABLE IF NOT EXISTS Plan (id INTEGER Primary KEY Autoincrement, name Varchar(45) NOT NULL, iduser INTEGER NOT NULL, totalprice INTEGER NOT NULL, FOREIGN KEY(iduser) REFERENCES User(id));")
